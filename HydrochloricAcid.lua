...
function HydrochloricAcid.ItemDamage(entity, amount, flags, source, countdownFrames)
  ...
  if source ~= nil
      and (source.Type == EntityType.ENTITY_PLAYER or source.Entity ~= nil and source.Entity.Parent ~= nil and source.Entity.Parent.Type == EntityType.ENTITY_PLAYER)
      and player:HasCollectible(CollectibleType.COLLECTIBLE_HYDROCHLORIC_ACID)
